...
class pinn:
    def __init__(self, device='cpu', reset=False) -> None:
        ...
        self.gpinn = False
        self.last_epoch = 0
        self.ex = 'rb_pre_without_model_ex6'
    ...
    def init_data(self):
        ...
        # self.x = data.y[0, :]
        self.t, self.acc_data = read_data(f'./datas/lorenz_sparse.csv')
        train_time = self.t[0:201]
        ...
        self.train_label = V(torch.from_numpy(self.acc_data[:, 0:201]).double()).T.to(self.device)
        self.train_PT = PT = torch.linspace(self.train_time[0, 0], self.train_time[-1, 0], 401).reshape(-1, 1).double()
    ...
    def init_ksi_LS(self):
        ...
        self.ksi.data = init_ksi_data(self.net, self.train_PT)
        print(self.ksi)
        torch.save(self.ksi, self.ksi_filename)
    ...
    def train_ksi(self, lr, epoch_num, cut, th):
        ...
        for epoch in range(epoch_num):
            ...
            msed, _, _ = discover(net=self.net, T=self.train_PT, ksi = self.ksi, Lambda=self.Lambda)
    ...
    def pre_train(self, lr, epoch_num, lb_num):
        self.train_regression(lr=lr, epoch_num=epoch_num, lb_num=lb_num)
        # train.train_ksi(lr=1e-2, epoch_num=50000, cut=False, th=1e-3)
        self.init_ksi_LS()
        # self.train(pos=0, lr1=1e-3, lr2=1e-2, epoch_num=10000, w1=1e-1, w2=1, w3=1e-5, cut=False, th=1)
...
if __name__ == '__main__':
    ...
    # train.pre_train(lr=1e-3, epoch_num=5000, lb_num=10000)
    # train.ado(pos=1, ado_num=1, tk_lr=1e-2, tn_lr=1e-4, tk_num=20000, tn_num=10000, tn_lb_num=10000, cut=True, th=1e-2, alpha=0.1)
    # train.ado(pos=2, ado_num=50, tk_lr=5e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.1)
    # train.ado(pos=3, ado_num=50, tk_lr=1e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=1)

    # train.ado(pos=4, ado_num=20, tk_lr=5e-3, tn_lr=1e-4, tk_num=500, tn_num=500, tn_lb_num=500, cut=True, th=1e-2, alpha=0.1)
    # train.ado(pos=5, ado_num=50, tk_lr=5e-3, tn_lr=1e-4, tk_num=500, tn_num=500, tn_lb_num=500, cut=True, th=1e-2, alpha=1)
    # train.ado(pos=4, ado_num=10, tk_lr=5e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.1)
    # train.ado(pos=5, ado_num=20, tk_lr=1e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=1)
    # train.ado(pos=6, ado_num=20, tk_lr=1e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=1)

    # train.pre_train(lr=1e-3, epoch_num=5000, lb_num=10000)
    # train.ado(pos=1, ado_num=1, tk_lr=1e-2, tn_lr=1e-4, tk_num=20000, tn_num=10000, tn_lb_num=10000, cut=True, th=1e-2, alpha=0.01)
    # train.ado(pos=2, ado_num=10, tk_lr=1e-2, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.01)
    # train.ado(pos=3, ado_num=10, tk_lr=5e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.01)
    # train.ado(pos=4, ado_num=10, tk_lr=5e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.1)
    # train.ado(pos=5, ado_num=20, tk_lr=1e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.1)
    # train.ado(pos=6, ado_num=20, tk_lr=1e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=1000, cut=True, th=1e-2, alpha=0.1)
