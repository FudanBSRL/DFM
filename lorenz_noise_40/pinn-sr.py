...
class pinn:
    def __init__(self, device='cpu', reset=False) -> None:
        ...
        self.gpinn = False
        self.last_epoch = 0
        self.ex = 'rb_pre_without_model_ex10'
        ...
        self.data_filename = f'./datas/lorenz_noise_snr40.csv'
...
if __name__ == '__main__':
    ...
    # train.ado(pos=3, ado_num=50, tk_lr=5e-3, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=2000, cut=True, th=1e-2, alpha=10)
    # train.ado(pos=4, ado_num=50, tk_lr=1e-4, tn_lr=1e-4, tk_num=1000, tn_num=1000, tn_lb_num=2000, cut=True, th=1e-2, alpha=10)
    # train.ado(pos=5, ado_num=20, tk_lr=1e-4, tn_lr=5e-5, tk_num=1000, tn_num=1000, tn_lb_num=2000, cut=True, th=1e-2, alpha=15)
    train.ado(pos=4, ado_num=20, tk_lr=1e-2, tn_lr=5e-5, tk_num=1000, tn_num=1000, tn_lb_num=2000, cut=True, th=1e-2, alpha=20)
